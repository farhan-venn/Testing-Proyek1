...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek_query = "SELECT * FROM pengunjung WHERE nama_siswa = '$nama_siswa'";
    $result = $koneksi->query($cek_query);

    if ($result->num_rows > 0) {
        echo "Data dengan Nama_siswa $nama_siswa sudah ada dalam database.";
    } else {
        // Tambahkan data ke tabel peminjaman
        $query = "INSERT INTO pengunjung (nama_siswa, kelas) 
                  VALUES ('$nama_siswa', '$kelas')";
